...
import { createGcp } from "../../../action/importXls.api";
import { Button } from "@/common/ui/Button";
import { Input } from "@/common/ui/Input";
import Label from "@/common/ui/Label";
import { useFormState } from "react-dom";

export default function AddGcp({ searchParams }) {
    const { errorMessage } = searchParams;
    const [state, formAction] = useFormState(createGcp, { error: "" });
        ...
        <div>
            ...
            >
                ...
                <div className="grid gap-2">
                    ...
                    <Input placeholder="Enter Gcp X" name="X" />
                </div>
                <div className="grid gap-2">
                    <Label required={true}>Gcp Y</Label>
                    <Input placeholder="Enter Gcp Y" name="Y" />
                </div>
                <div className="grid gap-2">
